...
export default function Register() {
  ...
  useAnimation(currentPageNumber);
          ...
          >
            ...
            <div className={'agree flex flex-col'}>
              ...
              <Button
                ...
                tabIndex={
                  registerPages[currentPageNumber] === 'agree' ? '' : '-1'
                }
              >
                네, 모두 동의합니다.
              </Button>
            ...
            <div className="email flex flex-col">
              <Input
                ...
                tabIndex={
                  registerPages[currentPageNumber] === 'email' ? '' : '-1'
                }
              />
            ...
            <div className="pwd flex flex-col">
              <Input
                ...
                tabIndex={
                  registerPages[currentPageNumber] === 'pwd' ? '' : '-1'
                }
              />
            ...
            <div className="name flex flex-col">
              <Input
                ...
                tabIndex={
                  registerPages[currentPageNumber] === 'name' ? '' : '-1'
                }
              />
            ...
            <div className="phone flex flex-col">
              <Input
                ...
                tabIndex={
                  registerPages[currentPageNumber] === 'phone' ? '' : '-1'
                }
              />
            ...
            <div className="birth flex flex-col gap-1">
              ...
              <LocalizationProvider dateAdapter={AdapterDayjs}>
                <DatePicker
                  ...
                  style={{ width: '2000px' }}
                  disabled={
                    registerPages[currentPageNumber] === 'birth' ? false : true
                  }
                />
              ...
              <div className="flex justify-between">
                <Button
                  ...
                  onClick={handlePreviousButton}
                  tabIndex={
                    registerPages[currentPageNumber] === 'birth' ? '' : '-1'
                  }
                >
                  이전
                </Button>
